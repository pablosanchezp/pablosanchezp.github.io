...
<div class="publications-div">
        ...
        <div class="container">
           <ul class="timeline">
              ...
              <li>
                 <!-- begin timeline-time -->
                 <div class="timeline-time">
                    <span class="time">September 2011</span>
                    <span class="time">June 2016</span>
                 </div>
                 <div class="timeline-time-small">
    ...
    <div id="teaching">
        ...
        <div class="about">
            ...
            <br>
            <ul>
                <li><b>Subject: Operating Systems </b></li>
    ...
    <div id="skills">
        ...
        <div class="about">
            <ul>
                ...
                <li><b>Programming languages:</b> C, Java, C#, SQL, Python and Bash (ease of learning any programming language).</li>
                <li><b>Software Development:</b> NetBeans, Eclipse and Visual Studio (general purpose) PostgreSQL, SQLServer, and MySQL (database management).</li>
